...
<body>	
	...
	<form id="location-form" action="">
		...
		<input type="submit" value="Submit" onClick="event.preventDefault(); returnCoordinates()">
	</form> 
	...
	<div class="shop-info mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
		...
		<table class="results-table mdl-data-table mdl-js-data-table mdl-shadow--2dp" style="width: 100%;">
			<thead>
				<tr>
					<th class="mdl-data-table__cell--non-numeric"><h5>Integer</h5></th>
					<th class="mdl-data-table__cell--non-numeric"><h5>mollis</h5></th>
				</tr>
			</thead>
			<tbody id="maintable">
